    ...
    render() {
        return (
            <section className='two-section'>
                <h2>Haftalık Bültenime kayıt olun!</h2>
                <h4>Her Cuma haftalık bültenimi mail kutunuzda bulabilirsiniz!</h4>
                <h4>Spam yok. Istediginiz zaman kaydınızı silin.</h4>
            <form action="https://youtube.us4.list-manage.com/subscribe/post?u=202596093129dd9f85893dc69&amp;id=de8bc456c2" method="GET" noValidate>
                ...
                <input type="submit" value="Abone Ol" name="subscribe" id="mc-embedded-subscribe" className="button" />
