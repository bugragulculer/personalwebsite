                ...
                <div className='FooterColumns'>
                    ...
                    <div  className='Footercolumn' >
                        ...
                        <div className='SocialAccounts' >
                            ...
                            <a href='https://twitter.com/BugraGulculerTR' className='Social'>
                            ...
                            <a href='https://medium.com/@bugrahangulculer' className='Social'>
                                <img src={spotify} alt='SpotifyLogo' className='SocialLogo' ></img>
                                <h3 className='SocialText'>Spotify</h3>
                            </a>
                            <a href='https://www.youtube.com/channel/UCz-QyCCL_itusMxXAU1V6zw' className='Social'>
